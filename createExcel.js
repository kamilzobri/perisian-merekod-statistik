...
var hariIni = process.argv[3];
var bulanDipilih = process.argv[4];
var tahunDipilih = process.argv[5];
if (hariIni != '') {
    hariIni = hariIni + 'hb';
}
...
workbook.xlsx.readFile('formatOriginalJANGANEDIT.xlsx')
    .then(function () {
        ...
        return workbook.xlsx.writeFile(`${path}/ statistik bulanan ${hariIni} ${bulanLetter} ${tahunDipilih}.xlsx`);
